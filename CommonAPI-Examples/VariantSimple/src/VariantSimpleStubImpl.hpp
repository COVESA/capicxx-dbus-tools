...
#include <v0_1/commonapi/examples/VariantSimpleStubDefault.hpp>

class VariantSimpleStubImpl : public v0_1::commonapi::examples::VariantSimpleStubDefault {
public:
	VariantSimpleStubImpl();
	virtual ~VariantSimpleStubImpl();

	virtual void callMe(const std::shared_ptr<CommonAPI::ClientId> _client, std::string _strArg, v0_1::commonapi::examples::VariantSimple::SampleUnion _varArg, callMeReply_t _reply);
