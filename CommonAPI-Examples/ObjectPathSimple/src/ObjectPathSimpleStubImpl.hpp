...
#include <v1_0/commonapi/examples/ObjectPathSimpleStubDefault.hpp>

class ObjectPathSimpleStubImpl: public v1_0::commonapi::examples::ObjectPathSimpleStubDefault {
