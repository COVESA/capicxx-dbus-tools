...
TEST_F(OutputStreamTest, WritesBytes) {
    ...
    EXPECT_EQ(numOfElements, size_t(message.getBodyLength()));
...
TEST_F(OutputStreamTest, WritesBools) {
    ...
    EXPECT_EQ(numOfElements*4, size_t(message.getBodyLength()));
...
TEST_F(OutputStreamTest, WritesUInt16) {
    ...
    EXPECT_EQ(numOfElements*2, size_t(message.getBodyLength()));
...
TEST_F(OutputStreamTest, WritesUInt64) {
    ...
    EXPECT_EQ(numOfElements*8, size_t(message.getBodyLength()));
...
TEST_F(OutputStreamTest, WritesArrays) {
    ...
    EXPECT_EQ(numOfElements*4 + 4, size_t(message.getBodyLength()));
...
TEST_F(OutputStreamTest, WritesArraysOfStrings) {
    ...
    EXPECT_EQ(vectorLength, size_t(message.getBodyLength()));
...
TEST_F(OutputStreamTest, WritesArraysInArrays) {
    ...
    EXPECT_EQ(numOfElements*numOfElements*4 + numOfElements*4 + 4, size_t(message.getBodyLength()));
...
TEST_F(OutputStreamTest, WritesTestStructs) {
    ...
    EXPECT_EQ(expectedSize, uint32_t(message.getBodyLength()));
...
TEST_F(OutputStreamTest, WritesStructsOfArraysWithSthBefore) {
    ...
    EXPECT_EQ(structLength, size_t(message.getBodyLength()));
...
TEST_F(OutputStreamTest, WritesEnumKeyedMaps) {
    ...
    EXPECT_EQ(sizeOfBody, size_t(message.getBodyLength()));
